...
var host = "35.197.23.188";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "727684";  //password (change to match your db, yes this is very poor practice)
